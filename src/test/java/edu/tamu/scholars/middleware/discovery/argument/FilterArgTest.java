...
public class FilterArgTest {
    ...
    public void testDefaultConstructor() {
        FilterArg filterArg = new FilterArg("class", "Concept", FilterOp.EQUALS, "CLAZZ");
        assertNotNull(filterArg);
        assertEquals("class", filterArg.getField());
        assertEquals("Concept", filterArg.getValue());
        assertEquals(FilterOp.EQUALS, filterArg.getOpKey());
    ...
    public void testOfQueryParameter() {
        ...
        Optional<String> opKey = Optional.of(FilterOp.EQUALS.getKey());
