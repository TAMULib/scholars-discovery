...
This provides a page of all the relationships present in the system, based on the _Query Parameters_ as shown.

===== Query Parameters
include::../{snippets}/relationships/page/query-parameters.adoc[]
...
This will find a list of relationships based on the _individual ids_ provided as a parameter as shown in *Query Parameters*. The json response will have the list of relationships as shown in the *Sample Response*.

===== Query Parameters
include::../{snippets}/relationships/search/findByIdIn/query-parameters.adoc[]
...
This search will return a json response listing all the relationships, based on the query parameters as shown in *Query Parameters*.

===== Query Parameters
include::../{snippets}/relationships/search/advanced/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/relationships/search/export/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/relationships/export/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/relationships/search/count/query-parameters.adoc[]
...
This will return a json response listing recently updated relationships, based on the query parameters as shown in *Query Parameters*.

===== Query Parameters
include::../{snippets}/relationships/search/recentlyUpdated/query-parameters.adoc[]
