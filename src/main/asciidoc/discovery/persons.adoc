...
This provides a page of all the persons present in the system, based on the _Query Parameters_ as shown.

===== Query Parameters
include::../{snippets}/persons/page/query-parameters.adoc[]
...
This will find a list of persons based on the _individual ids_ provided as a parameter as shown in *Query Parameters*. The json response will have the list of persons as shown in the *Sample Response*.

===== Query Parameters
include::../{snippets}/persons/search/findByIdIn/query-parameters.adoc[]
...
This search will return a json response listing all the persons, based on the query parameters as shown in *Query Parameters*.

===== Query Parameters
include::../{snippets}/persons/search/advanced/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/persons/search/export/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/persons/export/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/persons/search/count/query-parameters.adoc[]
...
This will return a json response listing recently updated persons, based on the query parameters as shown in *Query Parameters*.

===== Query Parameters
include::../{snippets}/persons/search/recentlyUpdated/query-parameters.adoc[]
