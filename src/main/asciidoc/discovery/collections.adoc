...
This provides a page of all the collections present in the system, based on the _Query Parameters_ as shown.

===== Query Parameters
include::../{snippets}/collections/page/query-parameters.adoc[]
...
This will find a list of collections based on the _individual ids_ provided as a parameter as shown in *Query Parameters*. The json response will have the list of collections as shown in the *Sample Response*.

===== Query Parameters
include::../{snippets}/collections/search/findByIdIn/query-parameters.adoc[]
...
This search will return a json response listing all the collections, based on the query parameters as shown in *Query Parameters*.

===== Query Parameters
include::../{snippets}/collections/search/advanced/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/collections/search/export/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/collections/export/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/collections/search/count/query-parameters.adoc[]
...
This will return a json response listing recently updated collections, based on the query parameters as shown in *Query Parameters*.

===== Query Parameters
include::../{snippets}/collections/search/recentlyUpdated/query-parameters.adoc[]
