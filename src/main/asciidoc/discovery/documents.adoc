...
This provides a page of all the documents present in the system, based on the _Query Parameters_ as shown.

===== Query Parameters
include::../{snippets}/documents/page/query-parameters.adoc[]
...
This will find a list of documents based on the _individual ids_ provided as a parameter as shown in *Query Parameters*. The json response will have the list of documents as shown in the *Sample Response*.

===== Query Parameters
include::../{snippets}/documents/search/findByIdIn/query-parameters.adoc[]
...
This search will return a json response listing all the documents, based on the query parameters as shown in *Query Parameters*.

===== Query Parameters
include::../{snippets}/documents/search/advanced/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/documents/search/export/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/documents/export/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/documents/search/count/query-parameters.adoc[]
...
This will return a json response listing recently updated documents, based on the query parameters as shown in *Query Parameters*.

===== Query Parameters
include::../{snippets}/documents/search/recentlyUpdated/query-parameters.adoc[]
