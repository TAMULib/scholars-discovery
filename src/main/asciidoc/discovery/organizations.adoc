...
This provides a page of all the organizations present in the system, based on the _Query Parameters_ as shown.

===== Query Parameters
include::../{snippets}/organizations/page/query-parameters.adoc[]
...
This will find a list of organizations based on the _individual ids_ provided as a parameter as shown in *Query Parameters*. The json response will have the list of organizations as shown in the *Sample Response*.

===== Query Parameters
include::../{snippets}/organizations/search/findByIdIn/query-parameters.adoc[]
...
This search will return a json response listing all the organizations, based on the query parameters as shown in *Query Parameters*.

===== Query Parameters
include::../{snippets}/organizations/search/advanced/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/organizations/search/export/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/organizations/export/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/organizations/search/count/query-parameters.adoc[]
...
This will return a json response listing recently updated organizations, based on the query parameters as shown in *Query Parameters*.

===== Query Parameters
include::../{snippets}/organizations/search/recentlyUpdated/query-parameters.adoc[]
