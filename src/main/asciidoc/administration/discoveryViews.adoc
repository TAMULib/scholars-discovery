...
This displays a list of all the discovery view objects based on parameters like page, size or sort feature based on name, collection etc as shown in *Query Parameters*.

===== Query Parameters
include::../{snippets}/discoveryViews/directory/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/discoveryViews/patch/query-parameters.adoc[]
