...
This displays a list of all the directory view objects based on parameters like page, size or sort feature based on name, collection etc as shown in *Query Parameters*.

===== Query Parameters
include::../{snippets}/directoryViews/directory/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/directoryViews/patch/query-parameters.adoc[]
