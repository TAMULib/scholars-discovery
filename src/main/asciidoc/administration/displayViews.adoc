...
This displays a list of all the display view objects based on parameters like page, size or sort feature based on name, collection etc as shown in *Query Parameters*.

===== Query Parameters
include::../{snippets}/displayViews/directory/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/displayViews/find-by-types-in/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/displayViews/patch/query-parameters.adoc[]
