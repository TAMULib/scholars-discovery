...
This displays a list of all the users based on parameters like page, size or sort feature based on name, organization etc as shown in *Query Parameters*.

===== Query Parameters
include::../{snippets}/users/directory/query-parameters.adoc[]
...
===== Query Parameters
include::../{snippets}/users/patch/query-parameters.adoc[]
