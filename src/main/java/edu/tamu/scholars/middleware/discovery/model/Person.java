...
public class Person extends Common {
    ...
    private List<String> publicationDates; // duplicate of selectedPublicationDate without encoded reference to
                                           // publication
    ...
    @NestedObject(properties = { @Reference(value = "capstoneAdvisedOfURL", key = "url"),
